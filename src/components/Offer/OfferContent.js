    ...
    return(
        <div className="offer">
            ...
            <div className="offer__offer-section offer-section-one">
                ...
                <div data-aos="fade-up" className="offer-section__p-one">
            ...
            <div className="offer__offer-section offer-section-three">
                ...
                <p data-aos="fade-up" className="offer-section__p-one">
