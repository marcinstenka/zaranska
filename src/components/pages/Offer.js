        ...
        <>
            ...
            <div className="offer">
                ...
                <div className="offer__offer-section offer-section-four">
                    ...
                    <div className="offer-section__dot"></div>
                    <p className="offer-section__p-two">Kurs zakłada 9 spotkań, każde trwające trzy godziny.</p>
                    <div className="offer-section__p-three">
                ...
                <div className="offer__offer-section offer-section-five">
                    ...
                    <p className="offer-section__p-two">Warsztaty będą odbywały się co dwa tygodnie przez 7 miesięcy. Czas trwania jednego spotkania  3 godziny. Liczebność grupy 8-10 osób.</p>
                </div>
